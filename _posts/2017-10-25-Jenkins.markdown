...
- 2.管理证书和描述文件插件配置<br/>
	（使用Keychains and Provisioning Profiles Management插件）
   ...
   > 回到jenkins页面进入如下操作进入证书插件管理页面
	...
	Password: 开机密码
	Description: 可以不填
	Code Signing Identity : iPhone Distribution: xxxxx Company of China, Ltd.
	
	```
	Provisioning Profiles配置:	

	```
	Filename: 填写当前证书对应的描述文件名称
	Provisioning Profiles Directory Path: /Users/Shared/Jenkins/Library/MobileDevice/Provisioning Profiles 
	UUID:3ff1xxx-xxxx-xxxx-xxxx-xxxxxbe09d1e7
